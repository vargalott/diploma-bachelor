...
# =================================================================
#
#   SUBMODULE: truecrypt:decryption
#   LOCAL ENTRY POINT: dialog_modules_encryption_truecrypt_decrypt
#
#   truecrypt
#   |-- truecrypt.sh
#   |-- bench.sh
...
#
#   COMMENT: encryption:truecrypt decrypt menu DIALOG
#
# =================================================================
    ...
    $DIALOG_OK)
      ...
      $DMENU_OPTION_3)
        ...
        if [ $correct -eq 1 ]; then
          ...
          sudo -E -S -k -p "" truecrypt -m=nokernelcrypto --password="$password" --mount "$path" "$mntdir" <<<"$rpass"
          ...
          # unmount volume
          sudo -E -S -k -p "" truecrypt -m=nokernelcrypto -d "$path" <<<"$rpass"
